...
function getOffsetRect(t) {
    var e = t.getBoundingClientRect(), n = document.body, i = document.documentElement, a = window.pageYOffset || i.scrollTop || n.scrollTop, s = window.pageXOffset || i.scrollLeft || n.scrollLeft, r = i.clientTop || n.clientTop || 0, o = i.clientLeft || n.clientLeft || 0, d = e.top + a - r, l = e.left + s - o;
    return{top: Math.round(d), left: Math.round(l)}
}
...
window.dhtmlx || (dhtmlx = function (t) {
    ...
    var r = [], o = e.evaluate(t, a, function () {
        return n
    }, s, null);
    ...
    var n = t.replace(/[\/]+/gi, "/").split("/"), i = null, a = 1;
    if (!n.length)return[];
    if ("." == n[0])i = [e]; else {
        if ("" !== n[0])return[];
    ...
    function r(t, i, a) {
        ...
        var o = Math.abs(Math.floor(((window.innerWidth || document.documentElement.offsetWidth) - r.offsetWidth) / 2)), d = Math.abs(Math.floor(((window.innerHeight || document.documentElement.offsetHeight) - r.offsetHeight) / 2));
    ...
    function h(t, e, n, i) {
        return"object" != typeof t && (t = {text: t, type: e, expire: n, id: i}), t.id = t.id || g.uid(), t.expire = t.expire || g.expire, t
    }
...
}(), gantt = {version: "2.1.0"}, dhtmlxEventable = function (obj) {
    ...
    if (t.getBoundingClientRect) {
        var i = t.getBoundingClientRect(), a = document.body, s = document.documentElement, r = window.pageYOffset || s.scrollTop || a.scrollTop, o = window.pageXOffset || s.scrollLeft || a.scrollLeft, d = s.clientTop || a.clientTop || 0, l = s.clientLeft || a.clientLeft || 0;
        return e = i.top + r - d, n = i.left + o - l, {y: Math.round(e), x: Math.round(n), width: t.offsetWidth, height: t.offsetHeight}
    }
    ...
    t = t || window.event;
    var e = t.target || t.srcElement, n = gantt.locate(e), i = gantt.locate(e, gantt.config.link_attribute), a = !gantt.checkEvent("onContextMenu") || gantt.callEvent("onContextMenu", [n, i, t]);
    ...
    t = t || window.event;
    var e = t.target || t.srcElement, n = gantt.locate(t), i = gantt._find_ev_handler(t, e, gantt._dbl_click, n);
    if (i && null !== n) {
...
}, dhtmlxDnD.prototype = {dragStart: function (t, e) {
    this.config = {obj: t, marker: null, started: !1, pos: this.getPosition(e), sensitivity: 4}, this._settings && dhtmlx.mixin(this.config, this._settings, !0);
    var n = dhtmlx.bind(function (e) {
        return this.dragMove(t, e)
    }, this), i = (dhtmlx.bind(function (e) {
    ...
    if (!this.config.marker && !this.config.started) {
        var n = this.getPosition(e), i = n.x - this.config.pos.x, a = n.y - this.config.pos.y, s = Math.sqrt(Math.pow(Math.abs(i), 2) + Math.pow(Math.abs(a), 2));
    ...
    this._click.gantt_close = dhtmlx.bind(function (t, e) {
        ...
        if (null !== e) {
            var i = this.getTaskNode(e), a = Math.max(i.offsetLeft - this.config.task_scroll_offset, 0);
    ...
    for (var t = this.config.columns, e = [], n = 0, i = this.locale.labels, a = this.config.scale_height - 2, s = 0; s < t.length; s++) {
        var r = s == t.length - 1, o = t[s];
        r && this._get_grid_width() > n + o.width && (o.width = this._get_grid_width() - n), n += o.width;
        var d = this._sort && o.name == this._sort.name ? "<div class='gantt_sort gantt_" + this._sort.direction + "'></div>" : "", l = ["gantt_grid_head_cell", "gantt_grid_head_" + o.name, r ? "gantt_last_cell" : "", this.templates.grid_header_class(o.name, o)].join(" "), _ = "width:" + (o.width - (r ? 1 : 0)) + "px;", h = o.label || i["column_" + o.name];
        h = h || "";
    ...
    /* if (!gantt._is_grid_visible())return null;
     ...
     var d = "gantt_cell" + (r ? " gantt_last_cell" : ""), l = "";
     if (o.tree) {
    ...
    var a = this.getTask(t), s = (this._branches[a.parent], this._branches[n]);
    ...
    var t = new dhtmlxDnD(this.$grid_data, {updates_per_second: 60});
    dhtmlx.defined(this.config.dnd_sensitivity) && (t.config.sensitivity = this.config.dnd_sensitivity), t.attachEvent("onBeforeDragStart", dhtmlx.bind(function (t, e) {
        ...
        var i = t.config, a = this._get_position(this.$grid_data), s = a.x + 10, r = n.pos.y - 10;
        ...
        var o = document.elementFromPoint(a.x - document.body.scrollLeft + 1, r - document.body.scrollTop), d = this.locate(o), l = this.getTask(t.config.id);
        if (this.isTaskExists(d) || (d = t.lastTaskOfLevel(l.$level), d == t.config.id && (d = null)), this.isTaskExists(d)) {
            var _ = gantt._get_position(o), h = this.getTask(d);
            if (_.y + o.offsetHeight / 2 < r) {
                var c = this.getGlobalTaskIndex(h.id), g = this._pull[this._order[c + 1 + (h.id == l.id ? 1 : 0)]];
                if (g) {
                    if (g.id == l.id)return;
                    h = g
            ...
            if (h.$level == l.$level && l.id != h.id)this.moveTask(l.id, 0, 0, h.id), i.target = h.id; else {
                if (l.id == h.id)return;
                var c = this.getGlobalTaskIndex(h.id), u = this._pull[this._order[c - 1]];
    ...
    for (var a = this.splitSize(i, t.length), s = n, r = [], o = t.length - 1; o >= 0; o--) {
        var d = o == t.length - 1, l = this.initScaleConfig(t[o]);
    ...
    var e = dhtmlx.mixin({count: 0, col_width: 0, full_width: 0, height: 0, width: [], trace_x: []}, t);
    ...
    this.iterateScales(t, e, n, i, function (n, i, a, s) {
        var r = this.getSum(t.width, a, s - 1), o = this.getSum(e.width, n, i - 1);
        o != r && this.setSumWidth(r, e, n, i - 1)
    })
}, eachColumn: function (t, e, n) {
    var i = new Date(gantt._min_date), a = new Date(gantt._max_date);
    ...
    var e = t.trace_x, n = 0, i = t.width.length - 1, a = 0;
    ...
    var r = e.length - 1, o = e[r], d = gantt.date.add(o, t.step, t.unit);
...
/*    var t = gantt.$task_data;
    ...
    var i = gantt.config, a = this._drag_task_coords(t, n);
    ...
    var i = this._drag_task_coords(t, n), a = Math.max(0, n.pos.x - i.start);
    t.progress = Math.min(1, a / (i.end - i.start))
}, _move: function (t, e, n) {
    var i = this._drag_task_coords(t, n), a = gantt._date_from_pos(i.start + e), s = gantt._date_from_pos(i.end + e);
    ...
    var n = e.obj_s_x = e.obj_s_x || gantt.posFromDate(t.start_date), i = e.obj_e_x = e.obj_e_x || gantt.posFromDate(t.end_date);
    ...
    if (e.mode) {
        ...
        var a = n.x - e.start_x, s = gantt.getTask(e.id);
        if (this._handlers[e.mode]) {
            var r = dhtmlx.mixin({}, s), o = dhtmlx.mixin({}, s);
    ...
    if (2 != t.button && !gantt.config.readonly && !this.drag.mode) {
        ...
        if (i)if (i.mode && i.mode != gantt.config.drag_mode.ignore && gantt.config["drag_" + i.mode]) {
            var a = gantt.locate(e), s = dhtmlx.copy(gantt.getTask(a) || {});
        ...
        } else this.clear_drag_state(); else if (gantt.checkEvent("onMouseDown") && gantt.callEvent("onMouseDown", [n.split(" ")[0]]) && e.parentNode)return this.on_mouse_down(t, e.parentNode)
    }
    ...
    gantt.config.work_time && gantt.config.correct_work_time && (e.mode == gantt.config.drag_mode.resize ? e.left ? t.start_date = gantt.getClosestWorkTime({date: t.start_date, dir: "future"}) : t.end_date = gantt.getClosestWorkTime({date: t.end_date, dir: "past"}) : e.mode == gantt.config.drag_mode.move && (gantt.isWorkTime(t.start_date) ? gantt.isWorkTime(new Date(+t.end_date - 1)) || (t.end_date = gantt.getClosestWorkTime({date: t.end_date, dir: "past"}), t.start_date = gantt.calculateEndDate(t.end_date, -1 * t.duration)) : (t.start_date = gantt.getClosestWorkTime({date: t.start_date, dir: "future"}), t.end_date = gantt.calculateEndDate(t.start_date, t.duration))))
    ...
    var e = gantt.config.drag_mode, n = (t || "").split(" "), i = n[0], a = {mode: null, left: null};
    switch (i) {
    ...
    var a = null;
    if (a = "object" == typeof t ? t : {source: t, target: e, type: this._get_link_type(n, i)}, !a)return!1;
    ...
    var n = gantt._drawer, i = n.get_lines(e), a = document.createElement("div"), s = "gantt_task_link", r = this.templates.link_class ? this.templates.link_class(t) : "";
    ...
    var d = i[i.length - 1].direction, l = gantt._render_link_arrow(e[e.length - 1], d);
    return a.appendChild(l), a
}, gantt._render_link_arrow = function (t, e) {
    var n = document.createElement("div"), i = gantt._drawer, a = t.y, s = t.x, r = gantt.config.link_arrow_size, o = gantt.config.row_height, d = "gantt_link_arrow gantt_link_arrow_" + e;
    switch (e) {
        case i.dirs.right:
            a -= (r - o) / 2, s -= r;
            break;
    ...
    var e = dhtmlx.copy(t), n = this.current_pos, i = this._get_line(n, e);
    this.path.push(i), this.current_pos = e
}, get_path: function () {
    return this.path
}, get_wrapper_sizes: function (t) {
    var e, n = gantt.config.link_wrapper_width, i = (gantt.config.link_line_width, t.y + (gantt.config.row_height - n) / 2);
    switch (t.direction) {
        case this.dirs.left:
            e = {top: i, height: n, lineHeight: n, left: t.x - t.size - n / 2, width: t.size + n};
            break;
        case this.dirs.right:
            e = {top: i, lineHeight: n, height: n, left: t.x - n / 2, width: t.size + n};
            break;
        case this.dirs.up:
            e = {top: i - t.size, lineHeight: t.size + n, height: t.size + n, left: t.x - n / 2, width: n};
            break;
        case this.dirs.down:
            e = {top: i, lineHeight: t.size + n, height: t.size + n, left: t.x - n / 2, width: n}
    }
    return e
    ...
    switch (t.direction) {
        case this.dirs.left:
        case this.dirs.right:
            e = {height: n, width: a, marginTop: (i - n) / 2, marginLeft: (i - n) / 2};
            break;
        case this.dirs.up:
        case this.dirs.down:
            e = {height: a, width: n, marginTop: (i - n) / 2, marginLeft: (i - n) / 2}
    }
    return e
    ...
    var i = this.get_line_sizes(t), a = document.createElement("div");
    ...
    var e = this.get_endpoint(t), n = gantt.config, i = e.e_y - e.y, a = e.e_x - e.x, s = gantt._drawer.dirs;
    this.clear(), this.point({x: e.x, y: e.y});
    var r = 2 * n.link_arrow_size, o = e.e_x > e.x;
    if (t.type == gantt.config.links.start_to_start)
        this.point_to(s.left, r), o ? (this.point_to(s.down, i), this.point_to(s.right, a)) : (this.point_to(s.right, a), this.point_to(s.down, i)), this.point_to(s.right, r);
    else if (t.type == gantt.config.links.finish_to_start)
       if(i==0){
           this.point_to(s.right, a);
       }
       else if (o = e.e_x > e.x + 2 * r, this.point_to(s.right, r), o){
            a -= r;
    ...
    } else if (t.type == gantt.config.links.finish_to_finish)this.point_to(s.right, r), o ? (this.point_to(s.right, a), this.point_to(s.down, i)) : (this.point_to(s.down, i), this.point_to(s.right, a)), this.point_to(s.left, r); else if (t.type == gantt.config.links.start_to_finish)if (o = e.e_x > e.x - 2 * r, this.point_to(s.left, r), o) {
        a += 2 * r;
        var d = i > 0 ? 1 : -1;
    ...
    var e = gantt.config.links, n = !1, i = !1;
    ...
    var a = gantt._get_task_visible_pos(gantt._pull[t.source], n), s = gantt._get_task_visible_pos(gantt._pull[t.target], i);
    return{x: a.x, e_x: s.x, y: a.y, e_y: s.y}
    ...
    function s(t, e, n, a) {
        var s = d(), l = i(), _ = ["gantt_link_direction"];
        ...
        if (h = Math.max(0, h - 3)) {
            s.className = _.join(" ");
            var c = (a - e) / (n - t), g = Math.atan(c);
            2 == o(t, n, e, a) ? g += Math.PI : 3 == o(t, n, e, a) && (g -= Math.PI);
            var u = Math.sin(g), f = Math.cos(g), p = Math.round(e), m = Math.round(t), v = ["-webkit-transform: rotate(" + g + "rad)", "-moz-transform: rotate(" + g + "rad)", "-ms-transform: rotate(" + g + "rad)", "-o-transform: rotate(" + g + "rad)", "transform: rotate(" + g + "rad)", "width:" + Math.round(h) + "px"];
            if (-1 != window.navigator.userAgent.indexOf("MSIE 8.0")) {
                v.push('-ms-filter: "' + r(u, f) + '"');
                var k = Math.abs(Math.round(t - n)), x = Math.abs(Math.round(a - e));
                switch (o(t, n, e, a)) {
                    case 1:
                        p -= x;
                        break;
    ...
    var _ = new dhtmlxDnD(this.$task_bars, {sensitivity: 0, updates_per_second: 60}), h = "task_left", c = "task_right", g = "gantt_link_point", u = "gantt_link_control";
    _.attachEvent("onBeforeDragStart", dhtmlx.bind(function (e, n) {
        ...
        if (gantt._locate_css(i, g)) {
            ...
            var s = gantt._link_source_task = this.locate(n), r = gantt.getTask(s), o = 0;
        ...
        var r = _.config, o = _.getPosition(a);
        n(r.marker, o);
        var d = gantt._is_link_drop_area(a), l = gantt._link_target_task, h = gantt._link_landing, g = gantt._link_target_task_start, f = gantt.locate(a), p = !0;
        if (d && (p = !gantt._locate_css(a, c), d = !!f), gantt._link_target_task = f, gantt._link_landing = d, gantt._link_target_task_start = p, d) {
            var m = gantt.getTask(f), v = gantt._locate_css(a, u), k = 0;
        ...
        if (t.from && t.to && t.from != t.to) {
            ...
            e && gantt.addLink({source: t.from, target: t.to, type: e})
        }
    ...
    this._tasks = {col_width: this.config.columnWidth, width: [], full_width: 0, trace_x: [], rendered: {}}, this._click.gantt_task_link = dhtmlx.bind(function (t) {
        ...
        var e = this.locate(t), i = this.getTask(e), a = null;
    ...
    var e = this._create_filter("_filter_task", "_is_grid_visible"), n = this._create_filter("_filter_task", "_is_chart_visible"), i = this._create_filter("_filter_link", "_is_chart_visible");
    ...
    if (t && this.callEvent("onLinkDblClick", [t, e])) {
        ...
        var n = "", i = gantt.locale.labels.link + " " + this.templates.link_description(this.getLink(t)) + " " + gantt.locale.labels.confirm_link_deleting;
    ...
    var e = this._get_tasks_data(), n = this._init_task({id: this.config.root_id});
    e.push(n);
    var i = -1 / 0, a = 1 / 0;
    ...
    for (var s = 0; s < t.count; s++) {
        ...
        var r = i.call(this, n), o = t.width[s], d = "", l = "", _ = "";
        if (o) {
    ...
    if (this._is_chart_visible()) {
        var a = this._scale_helpers, s = [a.primaryScale()].concat(this.config.subscales);
        ...
        for (var r = this._get_resize_options(), o = r.x ? 0 : this.$task.offsetWidth, d = a.prepareConfigs(s, this.config.min_column_width, o, i), l = this._tasks = d[d.length - 1], _ = [], h = this.templates.scale_row_class, c = 0; c < d.length; c++) {
            var g = "gantt_scale_line", u = h(d[c]);
    ...
    var e = gantt._tasks, n = e.count, i = [];
    ...
    var l = t.$index % 2 !== 0, _ = gantt.templates.task_row_class(t.start_date, t.end_date, t), h = "gantt_task_row" + (l ? " odd" : "") + (_ ? " " + _ : "");
    ...
    var n = this._get_task_renderers(), i = this.getTask(t);
    if (i && this.isTaskVisible(t))for (var a = 0; a < n.length; a++)n[a].render_item(i); else for (var a = 0; a < n.length; a++)n[a].remove_item(t);
    if (void 0 === e || e) {
    ...
    var i = [t];
    e && i.push(e);
    var a = gantt.getState(), s = this.getTask(n);
    ...
    if (r.link_source_id == n && i.push("gantt_link_source"), r.link_target_id == n && i.push("gantt_link_target"), r.link_landing_area && r.link_target_id && r.link_source_id && r.link_target_id != r.link_source_id) {
        var o = r.link_source_id, d = r.link_source_start, l = r.link_target_start, _ = gantt.isLinkAllowed(o, n, d, l), h = "";
    ...
    +n.end_date <= +a.max_date && t.appendChild(i(e + " task_right")), +n.start_date >= +a.min_date && t.appendChild(i(e + " task_left"))
    ...
    var e = this._get_task_pos(t), n = this.config, i = this._get_task_height(), a = Math.floor((this.config.row_height - i) / 2);
    ...
    s.setAttribute(this.config.task_attribute, t.id),
        ...
        s.style.cssText = ["left:" + e.x + "px", "top:" + (a + e.y) + "px", "height:" + i + "px", "line-height:" + i + "px", "width:" + r + "px"].join(";");
    ...
    n = Math.max(n - 2, 0);
    var a = document.createElement("div"), s = Math.round(n * i);
    ...
    var a = (t - i) / e.width[n], s = gantt._get_coll_duration(e, e.trace_x[n]), r = new Date(e.trace_x[n].valueOf() + Math.round(a * s));
    return r
    ...
    var e = new Date(t), n = gantt._tasks.trace_x, i = gantt._tasks.ignore_x;
    ...
    e = e !== !1, n = n || 0;
    var i = t.type == this.config.types.milestone, a = this.posFromDate(e || i ? t.start_date : t.end_date), s = this._y_from_ind(this._get_visible_order(t.id));
    return i && (e ? a -= n : a += n), {x: a, y: s}
    ...
    var n = _isIE ? document.documentElement : document.body, e = {x: t.clientX + n.scrollLeft - n.clientLeft, y: t.clientY + n.scrollTop - n.clientTop}, i = gantt._get_position(gantt.$task_data);
    ...
    return this._task_area_pulls || (this._task_area_pulls = {}), this._task_area_renderers || (this._task_area_renderers = {}), this._task_area_renderers[t] ? this._task_area_renderers[t] : (e || dhtmlx.assert(!1, "Invalid renderer call"), this._task_area_renderers[t] = {render_item: function (a, s) {
     ...
     render_items: function (e, i) {
        ...
        if(i.className=="gantt_task_bg"&&r>0) r= Math.min(gantt.column_counter, r);
        for (var a = document.createDocumentFragment(), s = 0; r > s; s++)
                this.render_item(e[s], a),
                i.appendChild(a)
    ...
    ,
    rendered: this._task_area_pulls[t], node
    :
    n
}, this._task_area_renderers[t]
)
},
gantt._pull = {}, gantt._branches = {}, gantt._order = [], gantt._order_map = {}, gantt._lpull = {}, gantt.load = function (t, e, n) {
    ...
    for (var e = t.data, n = 0; n < e.length; n++) {
        ...
        //TODO: parse data
        //TODO: push {id, order} into _order_map{};
        // if t.sameColumnwith == undefined -> push(id,columnCounter),columnCounter ++;
        //else push(id, t.sameColumnWith)

        if ((typeof (i.parentTask) == undefined || e.parentTask == null) && this._order_map.get(i.parentTask) == null) {
            this._order_map.set(i.id, this.column_counter++);
        } else if (( existingColumn = this._order_map.get(i.parentTask)) != null && existingColumn <= this.column_counter) {
            this._order_map.set(i.id, existingColumn);
        }
        // **********************************************
    ...
    for (var n in t)if (t.hasOwnProperty(n)) {
        e = !0;
        var i = t[n], a = this.serverList[n];
        if (!a)continue;
        a.splice(0, a.length);
        for (var s = 0; s < i.length; s++) {
            var r = i[s], o = dhtmlx.copy(r);
            o.key = o.value;
    ...
    this._order = [],
        this._sync_order_item({parentTask: this.parentTask, parent: this.config.root_id, $open: !0, $ignore: !0, id: this.config.root_id}), this._scroll_resize(), this._set_sizes()
    ...
    //TODO: retrieve the order from HASHMAP!
    var column;
    if (typeof(column = this._order_map.get(t)) != "undefined" && column != null && column
        <= this.column_counter && column >= 0) {
        return column;
    }
    ...
    for (var e = {}, n = t.doXPath("//coll_options"), i = 0; i < n.length; i++)for (var a = n[i].getAttribute("for"), s = e[a] = [], r = t.doXPath(".//item", n[i]), o = 0; o < r.length; o++) {
        for (var d = r[o], l = d.attributes, _ = {key: r[o].getAttribute("value"), label: r[o].getAttribute("label")}, h = 0; h < l.length; h++) {
            var c = l[h];
    ...
    n = n || "data", e.getXMLTopNode || (e = new dtmlXMLLoaderObject(function () {
    }), e.loadXMLString(t));
    ...
    var e = gantt.templates.xml_format(t.start_date), n = gantt.templates.xml_format(t.end_date);
    ...
    for (var n = {collections: {links: []}}, i = n.data = [], a = e.doXPath("//task"), s = 0; s < a.length; s++) {
...
}, gantt._working_time_helper = {units: ["year", "month", "week", "day", "hour", "minute"], hours: [8, 17], dates: {0: !1, 6: !1}, _get_unit_order: function (t) {
    ...
    var e = t.unit, n = gantt.date[e + "_start"](t.date), i = new Date(n), a = new Date(n), s = !0, r = 3e3, o = 0, d = "any" == t.dir || !t.dir, l = 1;
    ...
    this._branches[t.parent] || (this._branches[t.parent] = []), this._branches[t.parent].push(t.id), this._sync_parent(t), this._sync_order()
    ...
    this._lightbox_id == t && (this._lightbox_id = e), this._replace_branch_child(n.parent, t, e), this.callEvent("onTaskIdChange", [t, e])
    ...
    var n = this._working_time_helper, i = e >= 0 ? 1 : -1;
    ...
    t.setTransactionMode("POST", !0), t.serverProcessor += (-1 != t.serverProcessor.indexOf("?") ? "&" : "?") + "editing=true", t._serverProcessor = t.serverProcessor, t.styles = {updated: "gantt_updated", inserted: "gantt_inserted", deleted: "gantt_deleted", invalid: "gantt_invalid", error: "gantt_error", clear: ""}, t._methods = ["_row_style", "setCellTextStyle", "_change_id", "_delete_task"], this.attachEvent("onAfterTaskAdd", function (e) {
        ...
        var n;
        n = "tasks" == t._ganttMode ? this.isTaskExists(e) ? this.getTask(e) : {id: e} : this.isLinkExists(e) ? this.getLink(e) : {id: e};
        var i = {};
    ...
    "< div class = 'dhx_cal_ltitle' > <span class='dhx_mark'>&nbsp;</span>" +
    "   < span class = 'dhx_time' > </span>" +
    "    <span class='dhx_title'></span>" +
    "</div>  < div class= 'dhx_cal_larea' > </div>", gantt.showLightbox = function (t) {
    ...
    var e = e.slice(0), n = gantt.serverList(t);
    ...
    if (void 0 === t && (t = this.getLightboxType()), !this._lightbox || this.getLightboxType() != this._get_safe_type(t)) {
        ...
        var i = this._lightbox_template, a = this.config.buttons_left;
    ...
    for (var e = "", n = 0; n < t.length; n++) {
        ...
        if (i) {
            ...
            var a = t[n].hidden ? " style='display:none'" : "", s = "";
    ...
    if (t) {
        ...
        var e = window.pageYOffset || document.body.scrollTop || document.documentElement.scrollTop, n = window.pageXOffset || document.body.scrollLeft || document.documentElement.scrollLeft, i = window.innerHeight || document.documentElement.clientHeight;
    ...
    gantt.lightbox_events = {}, gantt.lightbox_events.dhx_save_btn = function () {
        ...
        if (e.getAttribute("dhx_button"))gantt.callEvent("onLightboxButton", [e.className, e, t]); else {
            var n, i, a;
            -1 != e.className.indexOf("dhx_custom_button") && (-1 != e.className.indexOf("dhx_custom_button_") ? (n = e.parentNode.getAttribute("index"), a = e.parentNode.parentNode) : (n = e.getAttribute("index"), a = e.parentNode, e = e.firstChild));
    ...
    for (var t = dhtmlx.mixin({}, this.getTask(this._lightbox_id)), e = this._get_typed_lightbox_config(), n = 0; n < e.length; n++) {
        ...
        i = i ? i.nextSibling : i;
        var a = this.form_blocks[e[n].type], s = a.get_value.call(this, i, t, e[n]);
    ...
    var n = t, i = e.getElementsByTagName("span");
    ...
    for (var a = this._get_typed_lightbox_config(this.getLightboxType()), s = 0; s < a.length; s++) {
        ...
        if (this.form_blocks[r.type]) {
            var o = document.getElementById(r.id).nextSibling, d = this.form_blocks[r.type], l = dhtmlx.defined(n[r.map_to]) ? n[r.map_to] : r.default_value;
    ...
    var a = document.getElementById(i.id), s = a.nextSibling, r = {section: i, header: a, node: s, getValue: function (t) {
...
},gantt.form_blocks = {getTimePicker: function (t, e) {
    var n = t.time_format;
    if (!n) {
        var n = ["%d", "%m", "%Y"];
    ...
    var i = this.config, a = this.date.date_part(new Date(gantt._min_date.valueOf())), s = 1440, r = 0;
    ...
    for (var o = "", d = 0; d < n.length; d++) {
        ...
        if (_) {
            var p = t.readonly ? "disabled='disabled'" : "", m = e ? " style='display:none'" : "";
    ...
    var e = this.form_blocks.getTimePicker.call(this, t), n = ["<div style='height:30px;padding-top:0px;font-size:inherit;text-align:center;' class='dhx_section_time'>"];
    ...
    {
        var a = this.config, s = t.getElementsByTagName("select"), r = i._time_format_order;
        i._time_format_size
    }
    if (a.auto_end_date)for (var o = function () {
        var t = new Date(s[r[2]].value, s[r[1]].value, s[r[0]].value, 0, 0), e = gantt.calculateEndDate(t, 1);
    ...
    var i = t.getElementsByTagName("select"), a = n._time_format_order, s = 0, r = 0;
    ...
    return e.end_date = new Date(i[a[2] + a.size].value, i[a[1] + a.size].value, i[a[0] + a.size].value, s, r), e.end_date <= e.start_date && (e.end_date = gantt.date.add(e.start_date, gantt._get_timepicker_step(), "minute")), {start_date: new Date(e.start_date), end_date: new Date(e.end_date)}
}, focus: function (t) {
    ...
    function a() {
        var e = gantt.form_blocks.duration._get_start_date.call(gantt, t, i), n = gantt.form_blocks.duration._get_duration.call(gantt, t, i), a = gantt.calculateEndDate(e, n);
    ...
    var r = this.config, o = t.getElementsByTagName("select"), d = t.getElementsByTagName("input"), l = d[1], _ = [d[0], d[2]], h = t.getElementsByTagName("span")[0], c = i._time_format_order;
    ...
    var n = t.getElementsByTagName("select"), i = e._time_format_order, a = 0, s = 0;
    ...
    return e.end_date = this.calculateEndDate(e.start_date, i), e.duration = i, {start_date: new Date(e.start_date), end_date: new Date(e.end_date)}
}, focus: function (t) {
    gantt._focus(t.getElementsByTagName("select")[0])
}}, typeselect: {render: function (t) {
    var e = gantt.config.types, n = gantt.locale.labels, i = [];
    for (var a in e)i.push({key: e[a], label: n["type_" + a]});
    t.options = i;
    var s = t.onchange;
    ...
    for (var a = t.template || gantt.templates.task_text, s = 0; s < n.length; s++) {
        ...
        void 0 === r && (r = ""), i.push({key: n[s].id, label: r})
    }
    ...
    if (this.getState().lightbox) {
        var n = this.getState().lightbox, i = this.getLightboxValues(), a = dhtmlx.copy(this.getTask(n));
        this.resetLightbox();
        var s = dhtmlx.mixin(a, i, !0), r = this.getLightbox(t ? t : void 0);
...
},dataProcessor.prototype = {setTransactionMode: function (t, e) {
    ...
    if (t) {
        ...
        var n = new dtmlXMLLoaderObject(this.afterUpdate, this, !0), i = this.serverProcessor + (this._user ? getUrlSymbol(this.serverProcessor) + ["dhx_user=" + this._user, "dhx_version=" + this.obj.getUserData(0, "version")].join("&") : "");
    ...
    if (a.getXMLTopNode("data"), a.xmlDoc.responseXML) {
        for (var s = a.doXPath("//data/action"), r = 0; r < s.length; r++) {
            var o = s[r], d = o.getAttribute("type"), l = o.getAttribute("sid"), _ = o.getAttribute("tid");
    ...
    var t = this, e = this.obj.getUserData(0, "version"), n = this.serverProcessor + getUrlSymbol(this.serverProcessor) + ["dhx_user=" + this._user, "dhx_version=" + e].join("&");
    n = n.replace("editing=true&", ""), this.getUpdates(n, function () {
        ...
        if (n.length) {
            ...
            for (var i = 0; i < n.length; i++) {
                var a = n[i].getAttribute("status"), s = n[i].getAttribute("id"), r = n[i].getAttribute("parent");
                switch (a) {
                    case"inserted":
    ...
    t || dhtmlx.message({type: "error", text: e, expire: -1})
    ...
    var e = "<div class='gantt_container'><div class='gantt_task'></div>";
    ...
    this.$grid = n[0], this.$task = n[0], this.$scroll_ver = n[1], this.$scroll_hor = n[2],
        this.$grid.innerHTML = "<div class='gantt_grid_scale'></div><div class='gantt_grid_data'></div>",
        this.$grid_scale = this.$grid.childNodes[0], this.$grid_data = this.$grid.childNodes[1],
    ...
    if (t.y && (this._obj.style.height = this._calculate_content_height() + "px"), t.x && (this._obj.style.width = this._calculate_content_width() + "px"), this._y = this._obj.clientHeight, !(this._y < 20)) {
        ...
        this._x < 20 ||
        (this.$grid_data.style.width = Math.max(0, 0) + "px",
        this.$task.style.width = Math.max(this._x - 2, 0) + "px");
    }
    ...
    if (e) {
        var n = Math.max(e.offsetLeft - this.config.task_scroll_offset, 0), i = e.offsetTop - (this.$task_data.offsetHeight - this.config.row_height) / 2;
        this.scrollTo(n, i)
    }
    ...
    dhtmlxEvent(this.$scroll_hor, "scroll", function () {
        ...
        if (t.wheelDeltaX) {
            if (e.x)return!0;
            var n = t.wheelDeltaX / -40, i = gantt.$task.scrollLeft + 30 * n;
    ...
    if (!(this._x < 20 || this._y < 20)) {
        var t = this._get_grid_width(), e = this._x - t, n = this._y - this.config.scale_height, i = this.config.scroll_size + 1, a = this.$task_data.offsetWidth - i, s = this.config.row_height * this._order.length, r = this._get_resize_options(), o = this._scroll_hor = r.x ? !1 : a > e, d = this._scroll_ver = r.y ? !1 : s > n;
    ...
    for (var i = gantt._get_target_node(t), a = ""; i;) {
        if (a = i.className) {
            ...
            if (s >= 0) {
                if (!n)return i;
                var r = 0 === s || !gantt._trim(a.charAt(s - 1)), o = s + e.length >= a.length || !gantt._trim(a.charAt(s + e.length));
                if (r && o)return i
            }
        }
        i = i.parentNode
    ...
    var i = n.getFullYear(), a = Math.round((n.getTime() - new Date(i, 0, 1).getTime()) / 864e5), s = 1 + Math.floor(a / 7);
    return s
    ...
    dhtmlx.mixin(gantt.config, {links: {finish_to_start: "0", start_to_start: "1", finish_to_finish: "2", start_to_finish: "3"}, types: {task: "task", project: "project", milestone: "milestone"}, duration_unit: "day", work_time: !1, correct_work_time: !1, skip_off_time: !1, autosize: !1, show_links: !0, show_task_cells: !0, show_chart: !0, show_grid: !0, min_duration: 36e5, xml_date: "%d-%m-%Y %H:%i", api_date: "%d-%m-%Y %H:%i", start_on_monday: !0, server_utc: !1, show_progress: !0, fit_tasks: !1, select_task: !0, readonly: !1, date_grid: "%Y-%m-%d", drag_links: !0, drag_progress: !0, drag_resize: !0, drag_move: !0, drag_mode: {resize: "resize", progress: "progress", move: "move", ignore: "ignore"}, round_dnd_dates: !0, link_wrapper_width: 20, root_id: 0, autofit: !0, columns: [
    ...
    ]}, drag_lightbox: !0, sort: !1, details_on_create: !0, details_on_dblclick: !0, initial_scroll: !0, task_scroll_offset: 100, task_height: "full", min_column_width: 70}), gantt.keys = {edit_save: 13, edit_cancel: 27}, gantt._init_template = function (t, e) {
        ...
        gantt._init_template("date_scale", !0), gantt._init_template("date_grid", !0), gantt._init_template("task_date", !0), dhtmlx.mixin(this.templates, {xml_date: this.date.str_to_date(n.xml_date, n.server_utc), xml_format: e(n.xml_date, n.server_utc), api_date: this.date.str_to_date(n.api_date), progress_text: function () {
            return""
        ...
        }, time_picker: e(n.time_picker), link_class: function () {
            return""
            ...
            t = gantt.getTask(t);
            var a = gantt.locale.labels, s = "<b>" + t.text + "</b> " + (e ? a.link_start : a.link_end) + "<br/>";
    ...
    "force" != this.config.touch && (this.config.touch = this.config.touch && (-1 != navigator.userAgent.indexOf("Mobile") || -1 != navigator.userAgent.indexOf("iPad") || -1 != navigator.userAgent.indexOf("Android") || -1 != navigator.userAgent.indexOf("Touch"))), this.config.touch && (window.navigator.msPointerEnabled ? this._touch_events(["MSPointerMove", "MSPointerDown", "MSPointerUp"], function (t) {
        ...
        return t.touches && t.touches.length > 1 ? null : t.touches[0] ? {target: t.target, pageX: t.touches[0].pageX, pageY: t.touches[0].pageY} : t
    }, function () {
        return!1
    }))
